...
def train(args, opts):
    ...
    checkpoint_path_latest = os.path.join(opts.new_checkpoint, 'latest_epoch_xsmall.pth.tr')
    checkpoint_path_best = os.path.join(opts.new_checkpoint, 'best_epoch_xsmall.pth.tr')
